...
# Эквивалентные преобразования на основе законов булевой алгебры
...
=item 1. B<Equivalent transformations based on the laws of Boolean algebra> ✅ (according to de Morgan's laws).
